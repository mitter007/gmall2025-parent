...
public class DwsTradeSkuOrderWindowSyncCache extends BaseApp {
    ...
    private void joinDim(SingleOutputStreamOperator<TradeSkuOrderBean> stream) {
        ...
        SingleOutputStreamOperator<TradeSkuOrderBean> spuStream = skuSteam.map(new DimMapFunction<TradeSkuOrderBean>() {
            @Override
            public String getRowKey(TradeSkuOrderBean bean) {
        ...
        SingleOutputStreamOperator<TradeSkuOrderBean> c1Stream = c2Stream.map(new DimMapFunction<TradeSkuOrderBean>() {
            @Override
            public String getRowKey(TradeSkuOrderBean bean) {
