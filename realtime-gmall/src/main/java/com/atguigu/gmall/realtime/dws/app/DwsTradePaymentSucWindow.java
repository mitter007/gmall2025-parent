...
//        {"id":"259172","user_id":"808","sku_id":"6","sku_num":"1","ts":1751014852}
        ...
        SingleOutputStreamOperator<TradePaymentBean> processDS = keyedStream.process(new ProcessFunction<JSONObject, TradePaymentBean>() {
            ...
            @Override
            public void processElement(JSONObject value, ProcessFunction<JSONObject, TradePaymentBean>.Context ctx, Collector<TradePaymentBean> out) throws Exception {
                ...
                out.collect(new TradePaymentBean("", "", "", paymentSucUniqueUserCount, paymentSucNewUserCount, ts));
            }
        });
